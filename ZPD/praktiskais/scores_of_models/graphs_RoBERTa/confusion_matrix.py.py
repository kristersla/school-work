...
actual_labels, predicted_labels = analyzer.analyze_sentiments_in_csv("praktiskais/scores_of_models/testing-larger.csv")
...
cm = confusion_matrix(actual_labels_lower, predicted_labels_lower, labels=analyzer.labels)
plt.figure(figsize=(8, 6))
sns.heatmap(cm, annot=True, fmt='d', cmap='Blues', xticklabels=analyzer.labels, yticklabels=analyzer.labels)
