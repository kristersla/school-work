...
def save_comments_to_json(video_id):
    ...
    with open('praktiskais/comments/comments.json', 'w', encoding='utf-8') as f:
        json.dump(comments, f, ensure_ascii=False, indent=4)

video_id = "gwCD5971zlo"
save_comments_to_json(video_id)

with open('praktiskais/comments/comments.json', 'r', encoding='utf-8') as f:
...
with open('praktiskais/comments/mix_C&R.json', 'w', encoding='utf-8') as file:
    json.dump(output_data, file, indent=4, ensure_ascii=False)

with open('praktiskais/comments/mix_C&R.json', 'r', encoding='utf-8') as f:
    comments = json.load(f)
...
if comments_in_english:
    with open('praktiskais/comments/only_english.json', 'w', encoding='utf-8') as f:
        json.dump(comments_in_english, f, ensure_ascii=False, indent=4)

if comments_not_in_english:
    with open('praktiskais/comments/comments_not_in_eng.json', 'w', encoding='utf-8') as f:
        json.dump(comments_not_in_english, f, ensure_ascii=False, indent=4)

translator = Translator()

with open('praktiskais/comments/comments_not_in_eng.json', 'r', encoding='utf-8') as f:
    comments_data = json.load(f)
...
with open('praktiskais/comments/only_english.json', 'r', encoding='utf-8') as f:
    english_comments = json.load(f)

translated_comments.extend(english_comments)

with open('praktiskais/comments/translated.json', 'w', encoding='utf-8') as f:
